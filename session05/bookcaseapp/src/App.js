...
function App() {
  ...
  return(
    <>
    <Router>
      <Header bookLength={bookcase.length}></Header>
      ...
      <Routes>
        <Route exact path="/" element={<BookList books={books} stored="library" addToBookcase={addToBookcase} removeFromBookcase={removeFromBookcase} />}></Route>
         ...
         <Route path="/bookcase" element={ <BookList books={bookcase} stored="bookcase"  removeFromBookcase={removeFromBookcase} ddToBookcase={addToBookcase} />}></Route>   
